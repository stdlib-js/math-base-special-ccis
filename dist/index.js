...
var n=require('@stdlib/math-base-special-sincos/dist').assign,c=require('@stdlib/math-base-special-exp/dist'),q=require('@stdlib/complex-float64-ctor/dist'),o=require('@stdlib/complex-float64-real/dist'),m=require('@stdlib/complex-float64-imag/dist'),e=[0,0];function p(i){var r,a,s;return r=o(i),a=m(i),n(r,e,1,0),a!==0&&(s=c(-a),e[0]*=s,e[1]*=s),new q(e[1],e[0])}u.exports=p
